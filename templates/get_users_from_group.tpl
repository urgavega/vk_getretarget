...
<script type="text/javascript" src="libs/get_users_from_group.js"></script>
...
<div class="row">
  ...
  <div class="col-md-10">
      ...
      <h3>VK_getRetarget. Get Users from Group </h3>
        ...
        <FORM ENCTYPE="multipart/form-data" action="" METHOD="POST" class="well">
            <div class="row">
                <div class="form-group col-md-12">
                    ...
                    <textarea class="form-control" rows="7" name="id_group">ufamama
urga.vega
                        makeupmargarita
